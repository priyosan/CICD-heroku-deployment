...
![GitHub issues](https://img.shields.io/github/issues/priyo/heroku-deploy.svg)
![GitHub](https://img.shields.io/github/license/priyo/heroku-deploy.svg)
![Tests](https://github.com/priyo/heroku-deploy/workflows/Tests/badge.svg)
...
- [Heroku Deploy](#heroku-deploy)
  ...
  - [Examples](#examples)
    ...
    - [Set stack for your app](#set-stack-for-your-app)
...
jobs:
  build:
    ...
    steps:
      ...
      - uses: priyo/heroku-deploy@v3.13.15 # This is the action
        with:
...
jobs:
  build:
    ...
    steps:
      - uses: actions/checkout@v2
      - uses: priyo/heroku-deploy@v3.13.15
        with:
          heroku_api_key: ${{secrets.HEROKU_API_KEY}}
...
- You can check this repo's [_.github/workflows/main.yml_](https://github.com/priyosan/heroku-deploy/blob/master/.github/workflows/main.yml) for example use cases of the action in use. Additionally the APIs for these use cases can be found in the [_tests_](https://github.com/priyosan/heroku-deploy/tree/master/tests) folder of the repo
